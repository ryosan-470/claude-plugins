...
Skills interact with external services via MCP tool names (e.g., `mcp__claude_ai_Atlassian__getConfluencePage`) with CLI fallback commands when MCP is unavailable.
